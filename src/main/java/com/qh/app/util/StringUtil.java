...
public class StringUtil {
	...
	public static boolean checkPhone(String mobilePhone) {
		Pattern p = Pattern
				.compile("^((13\\d{9}$)|(170\\d{8}$)|(15[0,1,2,3,5,6,7,8,9]\\d{8}$)|(18[0,2,5,6,7,8,9]\\d{8}$)|(147\\d{8}$))");
